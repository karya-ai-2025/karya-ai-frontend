...
export default function SideLeftBar({ projectMetadata }) {
  ...
  return (
    <div className="w-[260px] h-screen bg-gradient-to-b from-blue-600 to-purple-800 text-white flex-shrink-0 overflow-y-auto custom-scrollbar">
      {/* Back to Dashboard */}
      <div className="p-4 border-b border-blue-500/30">
        <button
          onClick={() => router.push('/business-dashboard')}
          className="w-full flex items-center space-x-2 text-blue-200 hover:text-white transition-colors"
        >
          <ArrowLeft size={16} />
      ...
      <div className="p-6 border-b border-blue-500/30">
        ...
        <div className="text-sm text-blue-200 mb-2">Credits left: 5</div>
